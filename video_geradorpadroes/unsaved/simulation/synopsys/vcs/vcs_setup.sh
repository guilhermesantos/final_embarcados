...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/submodules/unsaved_video_scaler_0.v \
  $QSYS_SIMDIR/submodules/unsaved_video_rgb_resampler_0.v \
  ...
  $QSYS_SIMDIR/submodules/unsaved_video_clipper_0.v \
  ...
  $QSYS_SIMDIR/submodules/unsaved_camera_decoder.v \
  ...
  $QSYS_SIMDIR/submodules/unsaved_camera_config.v \
  $QSYS_SIMDIR/submodules/unsaved_bayer_resampler.v \
  $QSYS_SIMDIR/unsaved.v \
  -top $TOP_LEVEL_NAME
# ----------------------------------------
# simulate
