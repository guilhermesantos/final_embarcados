	unsaved u0 (
		.camera_config_SDAT                              (<connected-to-camera_config_SDAT>),                              //                             camera_config.SDAT
		.camera_config_SCLK                              (<connected-to-camera_config_SCLK>),                              //                                          .SCLK
		.camera_in_PIXEL_CLK                             (<connected-to-camera_in_PIXEL_CLK>),                             //                                 camera_in.PIXEL_CLK
		.camera_in_LINE_VALID                            (<connected-to-camera_in_LINE_VALID>),                            //                                          .LINE_VALID
		.camera_in_FRAME_VALID                           (<connected-to-camera_in_FRAME_VALID>),                           //                                          .FRAME_VALID
		.camera_in_pixel_clk_reset                       (<connected-to-camera_in_pixel_clk_reset>),                       //                                          .pixel_clk_reset
		.camera_in_PIXEL_DATA                            (<connected-to-camera_in_PIXEL_DATA>),                            //                                          .PIXEL_DATA
